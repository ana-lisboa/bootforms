Trying to make [admwathan/bootforms](https://github.com/adamwathan/bootforms work with laravel 5.7)
...
'providers' => [
    //...
    'AnaLisboa\BootForms\BootFormsServiceProvider'
  ],
```
...
'aliases' => [
    //...
    'AnaLisboa' => 'AdamWathan\BootForms\Facades\BootForm'
  ],
```
